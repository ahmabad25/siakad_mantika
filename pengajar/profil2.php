...
<!-- Disini -->
<hr id="myhr">
<h4><b><i>&emsp;Update Teacher's Profile</h4></i></b>
<hr id="myhr">
<!-- Disini -->
<form action="" method="post" enctype="multipart/form-data">
<table width="61%" id="mytable">
<tr>
<th valign="top" width="212"><label for="id_pengajar">&emsp;Teacher's ID</label></th>
<th width="20" valign="top">:</th>
<th valign="top"><b><?php echo $id_pengajar;?></b></th>
</tr>

<tr>
<td valign="top"><label for="nama_pengajar">&emsp;Name</label></td>
<td valign="top">:</td>
<td valign="top" width="300"><?php echo $nama_pengajar;?>
</td>
</tr>
...
<tr>
  <td><b>&emsp;Picture</b></td>
    ...
    <td colspan="2"><label for="gambar"></label>
      ...
      => <a href='#' onclick='buka("pengajar/zoom.php?id=<?php echo $id_pengajar;?>")'><?php echo $gambar0;?></a></td><td width="213"><td width="121">
</tr>
...
<td colspan="2"><input name="Simpan" type="submit" id="Simpan" value="Save" />
        ...
        <a href="?mnu=profil"><input name="Batal" type="button" id="Batal" value="Cancel" /></a>
	</td></tr>
</table>
</form>
<hr id="myhr">
...
if(isset($_POST["Simpan"])){
	...
	$ubah=process($conn,$sql);
		if($ubah) {echo "<script>alert('Teacher data update successful!');document.location.href='?mnu=profil';</script>";}
		else{echo"<script>alert('Teacher data failed to update!');document.location.href='?mnu=profil';</script>";}
