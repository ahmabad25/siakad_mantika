  ...
  $jumq=getJum($conn,$sqlq);
	...
	$arrq=getData($conn,$sqlq);
		foreach($arrq as $dq) {							
				$status=$dq["status"];
?>    
<h4>List of <?php echo $status;?> Class Joined by <?php echo $siswa;?></h4>
<div>
<!-- Disini -->
...
echo"<tr bgcolor='$color'>
				...
				<td align='center'>
<a href='?mnu=ohistori&id1=$id_kelas&id2=$id_peserta'><img src='ypathicon/11.png' title='Lihat Nilai & Kehadiran'></a>
				</tr>";
			$no++;
			}//while
		}//if
