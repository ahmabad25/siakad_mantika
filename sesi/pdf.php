...
class PDF extends FPDF{
  function Header(){
    ...
    $this->Cell(20,0,'Data sesi',0,0,'L');
    $this->Ln();
    $this->Cell(5,1,'Laporan data sesi',0,0,'L');
    $this->Ln();
...
$pdf->Cell(2,1,'id_sesi','LR',0,'C',1);
$pdf->Cell(7,1,'hari','LR',0,'C',1);
$pdf->Cell(5,1,'waktu','LR',0,'C',1);
...
for ($j=0;$j<$i;$j++){
  ...
  $pdf->Cell(2,1,$cell[$j][0],'B',0,'L'); // id_sesi
  $pdf->Cell(7,1,$cell[$j][1],'B',0,'L'); // hari
  $pdf->Cell(5,1,$cell[$j][2],'B',0,'L'); // waktu
