...
<?php
	$sql="select * from `$tbnilai` where `id_periode`='$gid_periode' and id_kelas='$id_kelas' and id_peserta='$id_peserta' and jenis_tes='Final'";
	$jum=getJum($conn,$sql);
if($jum>0){
	$btnpro="Update Score";
	$d=getField($conn,$sql);
...
<tr>
	<th width="264" align="left"><label for="id_periode">&emsp;Class</label></th>
	<th width="21" align="left" valign="top">:</th>
...
<tr>
	...
	<td valign="top">:</td>
	<td width="298"><b><?php echo"$id_sesiH ($id_sesiW)";?></b></td>
</tr>

<tr>
<td width="264" height="32"><label for="id_kelas">&emsp;Room</label></td>
<td width="21" valign="top">:</td>
<td colspan="3" valign="top"><b><?php echo $id_ruangan;?></b></td>
</tr>

<tr>
<td width="264" height="32"><label for="id_kelas">&emsp;Term & Period</label></td>
<td width="21" valign="top">:</td>
<td colspan="3" valign="top"><b><?php echo"$term ($deskripsi)";?></b></td>
</tr>

<tr><td colspan="5"><hr id="myhr"></td></tr>

<tr>
<td height="33"><label for="id_siswa">&emsp;Student</label>
<td valign="top">:
<td colspan="3" valign="top"><b><?php echo"$nama_siswa ($id_siswa-$id_peserta)";?> </b></td>
</tr>

<tr>
<td height="37"><label for="jenis_tes">&emsp;Test Type</label></td>
<td valign="top">:</td>
<td valign="top" colspan="3"><b>Final Test</b>
</td></tr>

<tr>
<td height="33"><label for="ls_score">&emsp;Listening Comprehension Score</label>
<td valign="top">:
<td colspan="1"><input name="ls_score" type="text" id="ls_score" value="<?php echo $ls_score;?>" size="30" /></td>
<td width="176" rowspan="5"><b>* Grading Indicator :
				<br> - <i>A</i> : 100 - 86
                <br> - <i>B</i> : 85 - 71
                <br> - <i>C</i> : 70 - 56
                <br> - <i>D</i> : 55 - 41
...
<td valign="top">:<td colspan="3"><textarea name="catatan" cols="55" rows="3" id="catatan"><?php echo $catatan;?></textarea>
</td>
</tr>
...
<td colspan="3">	
    ...
    <a href="?mnu=fnilai&id1=<?php echo "$id_kelas&id2=$id_peserta";?>"><input name="Batal" type="button" id="Batal" value="Cancel" /></a>
</td></tr>
</table>
</form>
<hr id="myhr">
...
$simpan=process($conn,$sql);
		...
		else{echo"<script>alert('SAVE FAILED');document.location.href='?mnu=fnilai&id1=$id1&id2=$id2';</script>";}
}
	else{
...
$ubah=process($conn,$sql);
	...
	else{echo"<script>alert('UPDATE FAILED');document.location.href='?mnu=fnilai&id1=$id1&id2=$id2';</script>";}
	}//else simpan
}
?>