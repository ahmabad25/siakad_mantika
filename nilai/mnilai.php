...
<tr>
	<th width="273" align="left"><label for="id_periode">&emsp;Class</label></th>
	<th width="27" align="left" valign="top">:</th>
	<th colspan="3"><b>(<?php echo $id_program;?>) <?php echo $id_program1;?></b></th>
</tr>

<tr>
	<td ><label for="nama_periode">&emsp;Teacher</label></td>
	<td valign="top">:</td>
	<td colspan="3"><b><?php echo $id_pengajar;?></b></td>
</tr>

<tr>
	<td><label for="deskripsi">&emsp;Session</label></td>
	<td valign="top">:</td>
	<td colspan="3"><b><?php echo"$id_sesiH ($id_sesiW)";?></b></td>
</tr>

<tr>
<td width="273" height="32"><label for="id_kelas">&emsp;Room</label></td>
<td width="27" valign="top">:</td>
<td colspan="3" valign="top"><b><?php echo $id_ruangan;?></b></td>
</tr>

<tr>
<td width="273" height="32"><label for="id_kelas">&emsp;Term & Period</label></td>
<td width="27" valign="top">:</td>
...
<td valign="top">:</td>
<td valign="top" colspan="3"><b>Mid-Test</b></td></tr>

<tr>
<td height="33"><label for="ls_score">&emsp;Listening Comprehension Score</label>
<td valign="top">:
<td width="315" colspan="1"><input name="ls_score" type="text" id="ls_score" value="<?php echo $ls_score;?>" size="30" /></td>
<td width="175" rowspan="5"><b>* Grading Indicator :
				<br>
				 - <i>A</i> : 100 - 86
                <br> - <i>B</i> : 85 - 71
                <br> - <i>C</i> : 70 - 56
...
<td colspan="3">	
    ...
    <a href="?mnu=mnilai&id1=<?php echo "$id_kelas&id2=$id_peserta";?>"><input name="Batal" type="button" id="Batal" value="Cancel" /></a>
</td></tr>
</table>
</form>
<hr id="myhr">
...
$simpan=process($conn,$sql);
		...
		else{echo"<script>alert('SAVE FAILED');document.location.href='?mnu=mnilai&id1=$id1&id2=$id2';</script>";}
}
	else{
...
$ubah=process($conn,$sql);
	...
	else{echo"<script>alert('UPDATE FAILED');document.location.href='?mnu=mnilai&id1=$id1&id2=$id2';</script>";}
	}//else simpan
}
?>