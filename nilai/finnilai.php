...
<tr>
<th width="219" height="29" align="left"><label for="id_siswa">&emsp;Student's ID</label></th>
<th width="21" align="left" valign="top">:</th>
<th align="left"><b><?php echo"$id_siswa-$id_peserta";?></b></th>
<td width="177" rowspan="5">
<center>
<?php
...
<td valign="top">:</td>
<td valign="top" width="232"><?php echo strtoupper($nama_siswa);?>
</td>
</tr>
...
<td valign="top">:</td>
<td valign="top" colspan="2"><b>Final Test</b></td></tr>

<tr>
<td width="269" height="33"><label for="ls_score">&emsp;Listening Comprehension Score</label></td>
<td width="19" valign="top">:</td>
<td width="281" colspan="1"><input name="ls_score" type="text" id="ls_score" value="<?php echo $ls_score;?>" size="30" /></td>
<td width="505" rowspan="5"><b>* Grading Indicator :
				<br>
				 - <i>A</i> : 100 - 86
                <br> - <i>B</i> : 85 - 71
                <br> - <i>C</i> : 70 - 56
