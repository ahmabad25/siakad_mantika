...
$pdf->Cell(2,1,'id_admin','LR',0,'C',1);
$pdf->Cell(7,1,'nama_admin','LR',0,'C',1);
...
for ($j=0;$j<$i;$j++){
  ...
  $pdf->Cell(2,1,$cell[$j][0],'B',0,'L'); // id_admin
  $pdf->Cell(7,1,$cell[$j][1],'B',0,'L'); // nama_admin
