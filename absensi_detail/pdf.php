...
class PDF extends FPDF{
  function Header(){
    ...
    $this->Cell(20,0,'Data absensi_detail',0,0,'L');
    $this->Ln();
    $this->Cell(5,1,'Laporan data absensi_detail',0,0,'L');
    $this->Ln();
...
$pdf->Cell(7,1,'id_absensi','LR',0,'C',1);
$pdf->Cell(5,1,'id_siswa','LR',0,'C',1);
...
for ($j=0;$j<$i;$j++){
  ...
  $pdf->Cell(7,1,$cell[$j][1],'B',0,'L'); // id_absensi
  $pdf->Cell(5,1,$cell[$j][2],'B',0,'L'); // id_siswa
  $pdf->Cell(3,1,$cell[$j][3],'B',0,'L'); // email
  $pdf->Cell(9,1,$cell[$j][4],'B',0,'L'); // catatan
