...
$pdf->Cell(2,1,'id_peserta','LR',0,'C',1);
$pdf->Cell(7,1,'id_kelas','LR',0,'C',1);
...
for ($j=0;$j<$i;$j++){
  ...
  $pdf->Cell(2,1,$cell[$j][0],'B',0,'L'); // id_peserta
  $pdf->Cell(7,1,$cell[$j][1],'B',0,'L'); // id_kelas
  $pdf->Cell(5,1,$cell[$j][2],'B',0,'L'); // id_siswa
  $pdf->Cell(9,1,$cell[$j][3],'B',0,'L'); // catatan
  $pdf->Ln();
}
$pdf->Output();
/*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
